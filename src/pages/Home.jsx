    ...
    <>
      <div className="px-2 max-w-5xl mx-auto mt-10  lg:mt-20">
        <div className="mt-20 mb-14 text-center">
          <h1 className="mb-4 text-4xl font-bold md:text-5xl lg:text-5xl font-black-white text-left">
            What is educationX?
          </h1>
          <p className="text-lg font-normal lg:text-xl font-black-white text-justify leading-normal font-sans">
            ...
            Log in and write your first impression.
          </p>
        </div>
          ...
          {postList.map((post, index) => (
            <Link key={index} to={`/post/${post.id}`}>
              <article className="overflow-hidden line-clamp-1 transform transition-transform duration-300 hover:scale-105">
                <h2 className="mb-2 text-2xl font-semibold font-black-white truncate">
                  {post.title}
                </h2>
                <p className="mb-2 font-black-white truncate">{post.post}</p>
